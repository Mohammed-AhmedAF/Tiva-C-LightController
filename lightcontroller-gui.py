...
connectionFrame.grid(row=0,column=1,sticky=W+S+N+E,padx=5)
controlFrame.grid(row=0,column=0,sticky=W+S+N+E,padx=5)
...
statusLabel.grid(row=2,column=0,sticky=W+E,columnspan=1,padx=5)
osLabel.grid(row=2,column=1,sticky=W+E,padx=5,pady=5)
